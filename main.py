...
pygame.init()
pygame.display.set_caption("Dinosaur vs Bees – Parallax v28.3: Bee Init Order Fixed")
...
# ────────────────────────────────────────────────────────────────
# Bee sprite class – FIXED: reset_position called AFTER vx/vy set
# ────────────────────────────────────────────────────────────────
class Bee(pygame.sprite.Sprite):
    def __init__(self, scale=1.0, speed_mult=1.0):
        ...
        # Now safe to call reset_position
        self.reset_position()
    ...
    def reset_position(self):
        # Spawn off right if going left (vx < 0), off left if going right
        if self.vx < 0:
